...
--
-- Host: localhost
-- Generation Time: May 29, 2018 at 09:12 AM
...
('root', '[{"db":"quizz_db","table":"choices"},{"db":"quizz_db","table":"questions"}]');
...
('root', '2018-04-26 12:20:03', '{"collation_connection":"utf8mb4_unicode_ci"}');
...
-- Database: `quizz_db`
--
CREATE DATABASE IF NOT EXISTS `quizz_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `quizz_db`;
